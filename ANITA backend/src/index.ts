...
import { handleDeleteManualTransactionsOnBankLink } from './routes/delete-manual-transactions-on-bank-link';
...
import { handleAwardXP } from './routes/award-xp';
import { handleAppOpen } from './routes/app-open';
...
app.post('/api/v1/transactions/delete-manual-on-bank-link', handleDeleteManualTransactionsOnBankLink);
...
app.post('/api/v1/delete-account', handleDeleteAccount);
...
app.post('/api/v1/app-open', handleAppOpen);
...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log('   - POST /api/v1/transactions/delete-manual-on-bank-link');
  ...
  console.log('   - POST /api/v1/clear-user-data');
  console.log('   - POST /api/v1/delete-account');
  console.log('   - GET  /api/v1/financial-metrics');
  console.log('   - GET  /api/v1/xp-stats');
  console.log('   - POST /api/v1/xp-award');
  console.log('   - POST /api/v1/app-open');
